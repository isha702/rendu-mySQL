...
document.getElementById('inscriptionForm').addEventListener('submit', function(e) {
    ...
    // isSubmit = true pour afficher les erreurs sur les champs vides
    ...
    if (ok1 && ok2 && ok3 && ok4 && ok5 && ok6) {
        formMsg.textContent = '🎉 Inscription réussie ! Bienvenue dans le monde d\'Harry Potter !';
        formMsg.className = 'form-msg form-success';
    } else {
